...
const ClockComponent = () => {
  ...
  return (
    <div>
        ...
        {locationData && (
                    <div className='flex flex-row items-center justify-end text-[10px]   md:mb-0 mb-7 '>
                    <div className='flex justify-end flex-col w-full mr-4 2xl:mr-10 '>
                  <div className='flex flex-row uppercase justify-end tracking-[2px] text-right text-[8px] md:text-[10px]'>{getCurrentTime()} <div className='mx-4'>{locationData.city}</div> {locationData.country_name}</div>
