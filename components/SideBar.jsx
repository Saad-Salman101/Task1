...
const sidebaroff = () => {
  ...
  const getContent = () => {
    if (!isOpen) {
      return (
<div className='bg-black text-white flex flex-col h-[1079px] w-[40px] justify-start items-start overflow-y-hidden' onClick={handleSidebarToggle}>
  ...
  return (
    <div>
      ...
      >
        ...
        {/* <img src='/assets/SideBarLogo.png' alt=''  className=' w-[183px] mt-2 3xl:mt-8 '/> */
        }
...
<div className='transform -rotate-90 origin-center text-[14px] font-semibold uppercase border-l-2 border-[#BE9F56]  pl-2 pr-4 tracking-[3px] text-white'>products</div>
        ...
        <div className='uppercase tracking-[5px] text-[38px] 3xl:mt-2 text-[#333333]'>products</div>
        </div>
            ...
            <div >
            <div className='w-full uppercase text-[10px] text-white font-light text-left tracking-[2px] cursor-pointer my-2 3xl:m3-3 3xl:mb-2' onClick={() => handleSidebarItemClick('/signatures')}>electronic signature</div>
            ...
            <div>
            <div className='w-full uppercase text-[10px] text-white font-light text-left tracking-[2px] cursor-pointer my-2 3xl:mt-3 3xl:mb-2' onClick={() => handleSidebarItemClick('/ewitness')}> e-witness</div>
            ...
            <div>
            <div className='w-full uppercase text-[10px] text-white font-light text-left tracking-[2px] cursor-pointer my-2 3xl:mt-3 3xl:mb-2' onClick={() => handleSidebarItemClick('/identityverification')}> identify verification</div>
            ...
            <div className='w-full uppercase text-[10px] text-white font-normal text-right tracking-[2px] cursor-pointer my-2 3xl:mt-3' onClick={() => handleSidebarItemClick('/contracts')}> contracts</div>
            <div>
            <div className='w-full uppercase text-[10px] text-white font-light text-left tracking-[1px] cursor-pointer my-2 3xl:mt-3 3xl:mb-2' onClick={() => handleSidebarItemClick('/contractagreement')}> contract/agreement management</div>
            ...
            <div>
            <div className='w-full uppercase text-[10px] text-white font-light text-left tracking-[2px] cursor-pointer my-2 3xl:mt-3 3xl:mb-2' onClick={() => handleSidebarItemClick('/documentgeneration')}> document generation</div>
            ...
            <div>
            <div className='w-full uppercase text-[10px] text-white font-light text-left tracking-[2px] cursor-ponter my-2 3xl:mt-3 3xl:mb-2' onClick={() => handleSidebarItemClick('/datasecurity')}> data security</div>
            ...
            <div className='w-full uppercase text-[10px] text-white font-light text-right tracking-[2px] cursor-pointer my-2 3xl:mt-3 3xl:mb-2' onClick={() => handleSidebarItemClick('/history')}> history</div>
            <div>
            <div className='w-full uppercase text-[10px] text-white font-light text-left tracking-[2px] cursor-pointer my-2 3xl:my-3 3xl:mb-2' onClick={() => handleSidebarItemClick('/docsafe')}> doc.safe</div>
            ...
            <div>
            <div className='w-full uppercase text-[10px] text-white font-light text-left tracking-[2px] cursor-pointer my-2 3xl:mt-3 3xl:mb-2' onClick={() => handleSidebarItemClick('/clickwraps')}> clickwraps </div>
            ...
            <div>
            <div className='w-full uppercase text-[10px] text-white font-light text-left tracking-[2px] cursor-pointer my-2 3xl:mt-3 3xl:mb-2' onClick={() => handleSidebarItemClick('/webforms')}> web forms </div>
            ...
            <div className='w-full uppercase text-[10px] text-white font-light text-right tracking-[2px] flex flex-row justify-end  cursor-pointer my-2 3xl:mt-2 3xl:my-0' onClick={() => handleSidebarItemClick('/allproducts')}> all products <img src='/assets/SideBarRightArrow.png' alt='' className='ml-5' /> </div>
