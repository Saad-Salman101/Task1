...
<div className='transform -rotate-90 origin-center text-[14px] font-semibold uppercase border-l-2 border-[#BE9F56]  pl-2 pr-4 tracking-[3px] text-white'>products</div>
        ...
        <div className='uppercase tracking-[5px] text-[38px] 2xl:mt-2 text-[#333333]'>products</div>
            ...
            <div className='w-full uppercase text-[10px] text-white font-light text-right tracking-[2px] flex flex-row justify-end  cursor-pointer my-2 2xl:mt-2 2xl:my-0' onClick={() => handleSidebarItemClick('/allproducts')}> all products <img src='/assets/SideBarRightArrow.png' alt='' className='ml-5' /> </div>
