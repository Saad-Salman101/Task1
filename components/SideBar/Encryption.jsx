...
<div className='transform -rotate-90 origin-center text-[14px] font-semibold uppercase border-l-2 border-[#BE9F56]  pl-2 pr-4 tracking-[3px] text-white'> <br/>AES 256 encryption</div>
  </div>
        ...
        <div className='uppercase tracking-[5px] text-[38px] 2xl:mt-2 text-[#333333]'>AES-256 <br/> Encryption</div>
        </div>
