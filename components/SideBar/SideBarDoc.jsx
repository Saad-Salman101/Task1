...
const sidebaroff = () => {
  ...
  const getContent = () => {
    if (!isOpen) {
      return (
<div className='absolute bg-black text-white flex flex-col  w-[40px] h-[140px]  2xl:h-[180px]  justify-start items-start overflow-y-hidden' onClick={handleSidebarToggle}>
