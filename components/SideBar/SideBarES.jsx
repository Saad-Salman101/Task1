...
const sidebaroff = () => {
  ...
  const getContent = () => {
    if (!isOpen) {
      return (
<div className='bg-black text-white flex flex-col h-[187px]  2xl:h-[240px] w-[40px] justify-start items-start overflow-y-hidden' onClick={handleSidebarToggle}>

  <div className='  w-full  flex flex-col justify-center items-center 2xl:mt-4 mt-6'>
<div className='transform -rotate-90 origin-center text-[11px] uppercase 2xl:w-[197px] w-[175px]  border-r-2 border-golden mt-[58px] 2xl:mt-[80px]   tracking-[2px]  '  >Electronic   signature</div>
  </div>
