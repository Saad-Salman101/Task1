...
const sidebaroff = () => {
  ...
  const getContent = () => {
    if (!isOpen) {
      return (
<div className='absolute  bg-black text-white flex flex-col  w-[40px] h-[90px] 2xl:h-[125px]  justify-start items-start overflow-y-hidden' onClick={handleSidebarToggle}>

<div className=' w-full  flex flex-col justify-center items-center mt-1 '>
<div className='transform -rotate-90 origin-center text-[11px] uppercase tracking-[2px] w-[70px] mt-[36px]'>    Products</div>
  </div>
  ...
  return (
    <div>
      ...
      <Drawer
        ...
        style={sidebarStyle}
      >
        <div className='h-[100vh] bg-pink-500 flex flex-col items-start ml-2 overflow-y-scroll'>
