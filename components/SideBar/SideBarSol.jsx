...
const sidebaroff = () => {
  ...
  const getContent = () => {
    if (!isOpen) {
      return (
<div className='bg-black absolute text-white flex flex-col mt-[70px] 2xl:mt-[110px] h-[95px]  2xl:h-[110px]   w-[40px] justify-start items-start overflow-y-hidden' onClick={handleSidebarToggle}>

  <div className='  w-full  flex flex-col justify-center items-center 2xl:mt-2 '>
<div className='transform -rotate-90 origin-center text-[11px] uppercase w-[90px]  2xl:w-[110px]  border-r-2 border-golden  2xl:px-2 tracking-[2px] mt-10 '>   Solutions</div>
  </div>
  ...
  return (
    <div>
      ...
      <Drawer
        ...
        style={sidebarStyle}
      >
        <div className='h-[100vh] bg-green-500 flex flex-col items-start ml-2 overflow-y-scroll'>
