...
<div className='transform -rotate-90 origin-center text-[14px] font-semibold uppercase border-l-2 border-[#BE9F56]  pl-2 pr-4 tracking-[3px] text-white'>solutions</div>
  </div>
        ...
        <div className='uppercase tracking-[5px] text-[38px] 2xl:mt-2 text-[#333333]'>solutions</div>
        </div>
            ...
            <div className='w-full uppercase text-[10px] text-white font-semibold text-left tracking-[2px] cursor-pointer my-2 2xl:m3-3 2xl:mb-2' onClick={() => handleSidebarItemClick('/signatures')}>Solutione</div>
